...
module.exports = async function (client, message, args) {
        ...
        .addFields(
          ...
          **10: ** [\`${Radiostations[10 - 1].split(" ")[0]}\`](${
          ...
          `,
            ...
            { name: `:flag_bd: Bangla Radio`, value: ``, inline: true },
  ...
  **34: ** [\`${Radiostations[34 - 1].split(" ")[0]}\`](${
    ...
    const song = {
        ...
        url: args2[1],
        thumbnail:
            "https://cdn.discordapp.com/avatars/767885987740254291/e2118323433dac89f8321929e92dd469.png",
        duration: 10000,
    };
    ...
    message.channel.send(
        new MessageEmbed()
            .setColor("#fffff0")
            .setDescription(
                `**🔴 Searching 🔍 \`${Radiostations[i - 1].split(" ")[0]}\`**`
            )
    );
    //mute yourself
