const BOT_FULLNAME_AUTO_ERROR =
    "Wrong format: An example would be `!swedish spanish-text-here`, where the `spanish-text` is converted to swedish";
const BOT_ABBR_AUTO_ERROR =
    "Wrong format: An example would be `!de french-text-here`, where the `french-text-here` is converted to german";
const BOT_TRANS_SPECIFIC_ERROR =
