...
exports.write = (content, type = "log") => {
    ...
    switch (type) {
        case "load":
            typeColor = chalk.magenta(typeUpper);
            break;
        case "event":
            typeColor = chalk.cyan(typeUpper);
            break;
        case "cmd":
            typeColor = chalk.gray(typeUpper);
            break;
        case "ready":
            typeColor = chalk.green(typeUpper);
            break;
        case "warn":
            typeColor = chalk.yellow(typeUpper);
            break;
        case "error":
            typeColor = chalk.red(typeUpper);
            break;
        case "debug":
            typeColor = chalk.green(typeUpper);
            break;
        case "log":
            typeColor = chalk.blue(typeUpper);
            break;
    }

    return console.log(typeColor + " " + content);
};
